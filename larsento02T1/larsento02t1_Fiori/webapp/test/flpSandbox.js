		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SuccessFactorsAi",
									"targetURL": "#larsento02t1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"larsento02t1-display": {
								"semanticObject": "larsento02t1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=larsento02t1",
									"url": sap.ui.require.toUrl("larsento02t1")
								}
							}
						}
					}
