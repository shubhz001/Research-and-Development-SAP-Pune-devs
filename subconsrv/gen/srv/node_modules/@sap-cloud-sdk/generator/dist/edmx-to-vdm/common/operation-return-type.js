...
exports.cannotDeserialize = exports.parseOperationReturnType = void 0;
 ...
 * @internal
 */
function parseOperationReturnType(returnType, entities, complexTypes, extractResponse, serviceName) {
    if (!returnType) {
...
function getEdmReturnType(isCollection, isNullable, edmType, extractResponse) {
 ...
 * @internal
 */
function cannotDeserialize(returnType) {
    return returnType.returnTypeCategory === 'never';
}
exports.cannotDeserialize = cannotDeserialize;
