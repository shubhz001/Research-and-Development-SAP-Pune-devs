sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return Controller.extend("cpc.CPC_Dashboard_Dealer_Split.controller.View1", {	
		onInit: function () {	
			me = this;
			if (!me.dialog) {	
				me.dialog = sap.ui.xmlfragment("cpc.CPC_Dashboard_Dealer_Split.fragments.BusyLoader", this);	
			}	
		...
		handleOnlineSchedulingPress: function () {
			...
			var quad2TableModelName;
			var entitySet;		
			var entitySetQuad2Table;
			var quad2AcceptedCountKey;
			var quad2NoOfDaysWaitingKey;
			var totalOssLeadsKey;		
			var totalLeadsOfferedKey;		

			if(sDateTimeKey==="LY"){		
				dashboardModelName = "DashboardThirdScreenModel_LY";
				quad2TableModelName = "DashboardThirdScreenModel_DealerDetails_LY";
				entitySet = "/ZCV_CPCLG_SC03_Q0002Results";		
				entitySetQuad2Table = "/ZCV_CPCLG_SC03_Q0004Results";
				totalOssLeadsKey = "Z_OSSLEPR_04";		
				totalLeadsOfferedKey = "Z_LOFRD_04";	
				quad2AcceptedCountKey = "ZCN_STNREJ_3";
				quad2NoOfDaysWaitingKey = "ZNO_DY_WAIT_1";
			}else{		
				dashboardModelName = "DashboardThirdScreenModel";
				quad2TableModelName = "DashboardThirdScreenModel_DealerDetails";
				entitySet = "/ZCV_CPCLG_SC03_Q0001Results";		
				entitySetQuad2Table = "/ZCV_CPCLG_SC03_Q0003Results";
				totalOssLeadsKey = "Z_OSSLEPR_03";		
				totalLeadsOfferedKey = "Z_LOFRD_03";	
				quad2AcceptedCountKey = "ZCN_STNREJ_2";
				quad2NoOfDaysWaitingKey = "ZNO_DY_WAIT";
			}		
			...
			var quadModel2 = me.getOwnerComponent().getModel(quad2TableModelName);
			quadModel2.read(entitySetQuad2Table,{
				urlParameters: {
					$select: 'A2HHBXV4LNHY4T1BYOU7CGICK8BY,A2HKRZGGC5CO5XVI9L9VQPS3IJG4,A2HFIXM0NZDY40BWS5PWGIJY1XS0,A2HQOCKP51JQYFF66Z1R5R7MKY08,' + quad2AcceptedCountKey + "," + quad2NoOfDaysWaitingKey,
					$format: 'json'
				},
				filters: xFilter,
				success: function (oData, response) {
					...
					for(var i=0;i<oData.results.length;i++){		
							oModel.getData().Table.push({		
								"CustomerName": oData.results[i].A2HHBXV4LNHY4T1BYOU7CGICK8BY,		
								"Email": oData.results[i].A2HKRZGGC5CO5XVI9L9VQPS3IJG4,		
								"Phone": oData.results[i].A2HFIXM0NZDY40BWS5PWGIJY1XS0,		
								"ApptRequestedDate": oData.results[i].A2HQOCKP51JQYFF66Z1R5R7MKY08,		
								"Accepted": parseInt(oData.results[i][quad2AcceptedCountKey]),
								"NoOfDaysWaiting": parseInt(oData.results[i][quad2NoOfDaysWaitingKey])
							});		
					}
		...
		handleSortButtonPressed: function () {	
			if (!me.SortDialog) {	
				me.SortDialog = sap.ui.xmlfragment("cpc.CPC_Dashboard_Dealer_Split.fragments.SortDialog", this);	
		...
		handleValueHelpStatesLP:function(Evt){
			...
			me._oStatesLPValueHelpDialog = sap.ui.xmlfragment("cpc.CPC_Dashboard_Dealer_Split.fragments.ValueHelpDialogStatesLP", me);	
		...
		handleValueHelpStatesOSS:function(Evt){
			...
			me._oStatesOSSValueHelpDialog = sap.ui.xmlfragment("cpc.CPC_Dashboard_Dealer_Split.fragments.ValueHelpDialogStatesOSS", me);	
		...
		handleHyperLinkPressOnlineScheduling:function(){	
			...
			me.oDataModelScreen3_Hyperlink.read(entitySet,{	
				...
				success: function (oData, response) {	
					...
					me._oHyperlinkOnlineSchedulingDialog = sap.ui.xmlfragment("cpc.CPC_Dashboard_Dealer_Split.fragments.OnlineSchedulingHyperLink", me);	
		...
		handleHyperLinkPressLeadsProvided:function(){	
			...
			me.oDataModelScreen2_Hyperlink.read(entitySet,{	
				...
				success: function (oData, response) {	
					...
					me._oHyperlinkLeadsProvidedDialog = sap.ui.xmlfragment("cpc.CPC_Dashboard_Dealer_Split.fragments.LeadsProvidedHyperlink", me);	
		...
		handleHyperlinkLeadsProvidedExport:function(Evt){	
			var oExport = new Export({	
				...
				columns : [{	
					...
					name : "Caller Time",	
					template : {	
						content : "{A2HGFFU461J8FANI1YFJYIBE395B_T}  {A2HRDPSMU5H1BWJBB0K4LY00ID0H}"	
					}	
				}, {	
					name : "Caller City",	
					template : {	
